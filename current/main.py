...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if(msg.startswith(';p')):
            ...
            if(msg == ";p code"):
                await channel.send("Here's the code that makes me live: <https://github.com/GouravKhunger/pingu/blob/main/current/main.py>")
                return

            # get a random quote from zenquote's api
            if(msg == ";p quote"):
